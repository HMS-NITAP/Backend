const evenSemAcknowledgementAttachement = (date,image,name,contact,year,rollNo,regNo,paymentMode,amount,blockName,roomNo,cotNo,gender,floor) => {
    return `<!DOCTYPE html>
	<html>
        <head>
            <meta charset="UTF-8">
        ...
        <body>
            <div class="container">
                ...
                <div class="Acknowledgement">
                    <div class="Date">
                        <p class="title">Acknowledgement for Hostel Room Allocation Even Sem (B.Tech)</p>
                        <p>Date: ${date}</p>
                    </div>
                </div>
...
module.exports = evenSemAcknowledgementAttachement;