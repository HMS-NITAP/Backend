const evenSemRejectionLetter = (remarks) => {
	...
	<body>
		<div class="container">
			...
			<div class="body">
				<p>Dear Student,</p>
				<p>We regret to inform you that your hostel allotment application for the academic year 2024-25 (Even semester) has been rejected after the review, kindly again apply for registration with correct details.</p>
